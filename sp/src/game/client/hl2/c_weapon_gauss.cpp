...
void C_WeaponGauss::Precache( void ){
	...
	//PrecacheParticleSystem( "hl2mmod_muzzleflash_gauss_smokesprite_fan" );
...
void C_WeaponGauss::OnDataChanged(DataUpdateType_t updateType)
{
	...
	if ( m_bCharging && !m_bChargeEffectsActive )
	{
		...
		//m_hExhaustEffect = ParticleProp()->Create( "hl2mmod_muzzleflash_gauss_smokesprite_fan", PATTACH_ABSORIGIN_FOLLOW );
