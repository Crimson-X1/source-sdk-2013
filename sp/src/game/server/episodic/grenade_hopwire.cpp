...
#ifdef CRIMSON_MOD
ConVar hopwire_aftershock_enabled("hopwire_aftershock_enabled", "1", FCVAR_NONE, "If enabled, vortex grenades will produce an aftershock (\"concussive_blast\") when it stops sucking things in." );

// Mass requirement for the aftershock
ConVar hopwire_aftershock_mass("hopwire_aftershock_mass", "500", FCVAR_NONE, "Sets the minimum mass the vortex requires to produce an aftershock when it collapses.");
...
//		CreateDenseBall();
		...
		if (hopwire_aftershock_enabled.GetBool() == true)
		{
			...
			{
				DevMsg("Not enough mass consumed for aftershock. Minimum mass required: %.2f kilograms.\n", hopwire_aftershock_mass.GetFloat());
			}
		}
#endif // CRIMSON_MOD
